...
(function (global) {
    ...
    function renderList(slug, query) {
        ...
        fetchMeta(slug).then(function (meta) {
            ...
            var isHierarchyView = (vt === 'TreeView' || vt === 'OrgChart' || vt === 'Timeline' || vt === 'Sankey' || vt === 'Calendar' ||
                activeView === 'TreeView' || activeView === 'OrgChart' || activeView === 'Timeline' || activeView === 'Timetable' || activeView === 'Sankey' || activeView === 'Calendar');
