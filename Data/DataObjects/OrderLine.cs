...
public class OrderRow
{
    ...
    [DataField(Label = "Unit Price", Order = 3, Required = true, FieldType = Rendering.FormFieldType.Decimal)]
    public decimal UnitPrice { get; set; }

    [DataField(Label = "Line Total", Order = 4, Required = true, FieldType = Rendering.FormFieldType.Decimal)]
